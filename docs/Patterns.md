...
Еще курсы по алгоритмам https://neetcode.io/courses/advanced-algorithms/0
...
- Определить окно динамическое или фиксированное ?
- Проходим правым указателем
- Делаем валидацию
...
Используется если нужно найти сумму максимально длинной подстроки в массиве
Для каждой позиции получаем максимальную сумму если эта сумма последняя позиция интервала (!)
Ответ это максимум по всем таким позициям

## Разделяй и властвуй

Суть в том что нужно разбивать массив на 2 части и собирать какую то статистику для меньших
Сумма статистик - это и будет результат на ответ по всему массиву
Для рекурсии финиш - это пока не останется 1 элемент

На примере задач "Найти максимальную сумма подмассива"

- делим массив на 2 части и ищем в какой половинке лучшая сумма
- далее повторяем все тоже самое для лучшей половины

Кейс когда лучшая сумма через границу обоих

- для первой части нужно получить максимальную сумму на **суффиксе**
- для второй части нужно получить максимальную сумму на **префиксе**
- далее запускаем для целой половинки алгоритм
