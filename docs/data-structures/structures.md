...
*Для изучения алгоритмов работы со структурами данных см. [Паттерны решения задач](../algorithms/algorithm-patterns.md)*
*Для понимания сложности алгоритмов см. [Big O нотация](../algorithms/big-o-notation.md)*
